...
class DefectInspection:
    def __init__(self, config: SystemConfig = None, seg_model_path: str = "",obb_model_path: str =""):
    ...
    def load_models(self):
        if not self.obb_model_path:
            raise ValueError("OBB Model path not provided")
        elif not self.seg_model_path:
            raise ValueError("Seg Model path not provided")
        self.obb_model = YOLO(self.obb_model_path)
